## Step 1 Install จ้า (notion-cms คือชื่อโฟลเดอร์)

```sh
npx create-next-app@latest notion-cms
```
...
export const metadata: Metadata = {
  title: "WJEXS",
  description: "Design your life for your Business",
  keywords: "Design, Thailand, wasin, jex, wjex, wjexs, Business, One person business, PALM, Personal Branding"
};
```
